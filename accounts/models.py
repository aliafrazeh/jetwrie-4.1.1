...
class User(AbstractUser):
    ...
    blue_tick = models.BooleanField(default=False,verbose_name="Blue Tick")
    golden_tick = models.BooleanField(default=False,verbose_name="Golden Tick")
    black_tick = models.BooleanField(default=False,verbose_name="Black Tick")